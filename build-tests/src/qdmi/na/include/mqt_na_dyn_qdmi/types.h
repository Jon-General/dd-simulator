 ...
 * ```
 * struct MQT_NA_DYN_QDMI_Site_impl_d {
 *   size_t id;
 * };
 * ```
 */
typedef struct MQT_NA_DYN_QDMI_Site_impl_d *MQT_NA_DYN_QDMI_Site;
 ...
 * ```
 * struct MQT_NA_DYN_QDMI_Operation_impl_d {
 *   std::string name;
 * };
 * ```
 */
typedef struct MQT_NA_DYN_QDMI_Operation_impl_d *MQT_NA_DYN_QDMI_Operation;
