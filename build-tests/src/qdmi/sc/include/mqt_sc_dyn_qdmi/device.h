...
#include "mqt_sc_dyn_qdmi/types.h"     // IWYU pragma: export
 ...
 */
int MQT_SC_DYN_QDMI_device_initialize(void);
 ...
 */
int MQT_SC_DYN_QDMI_device_finalize(void);
 ...
 *  - Allocate a session with @ref MQT_SC_DYN_QDMI_device_session_alloc.
 *  - Set parameters for the session with @ref
 * MQT_SC_DYN_QDMI_device_session_set_parameter.
 *  - Initialize the session with @ref MQT_SC_DYN_QDMI_device_session_init.
 ...
 *  - Free the session with @ref MQT_SC_DYN_QDMI_device_session_free when it is no longer
 *    needed.
 *
 *  @{
 */
 ...
 */
typedef struct MQT_SC_DYN_QDMI_Device_Session_impl_d *MQT_SC_DYN_QDMI_Device_Session;
 ...
 * @c NULL. The session must be freed by calling @ref MQT_SC_DYN_QDMI_device_session_free
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see MQT_SC_DYN_QDMI_device_session_set_parameter
 * @see MQT_SC_DYN_QDMI_device_session_init
 */
int MQT_SC_DYN_QDMI_device_session_alloc(MQT_SC_DYN_QDMI_Device_Session *session);
 ...
 * an example.
 */
int MQT_SC_DYN_QDMI_device_session_set_parameter(MQT_SC_DYN_QDMI_Device_Session session,
 ...
 * @ref MQT_SC_DYN_QDMI_device_session_set_parameter before calling this function. A
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see MQT_SC_DYN_QDMI_device_session_set_parameter
 * @see MQT_SC_DYN_QDMI_device_session_query_device_property
 * @see MQT_SC_DYN_QDMI_device_session_query_site_property
 * @see MQT_SC_DYN_QDMI_device_session_query_operation_property
 * @see MQT_SC_DYN_QDMI_device_session_create_device_job
 */
int MQT_SC_DYN_QDMI_device_session_init(MQT_SC_DYN_QDMI_Device_Session session);
 ...
 */
void MQT_SC_DYN_QDMI_device_session_free(MQT_SC_DYN_QDMI_Device_Session session);
 ...
 *  MQT_SC_DYN_QDMI_Device_Session handles created via the @ref device_session_interface
 ...
 * @ref MQT_SC_DYN_QDMI_device_session_init.
 */
int MQT_SC_DYN_QDMI_device_session_query_device_property(MQT_SC_DYN_QDMI_Device_Session session,
 ...
 * @ref MQT_SC_DYN_QDMI_device_session_init.
 */
int MQT_SC_DYN_QDMI_device_session_query_site_property(MQT_SC_DYN_QDMI_Device_Session session,
                                            MQT_SC_DYN_QDMI_Site site,
...
int MQT_SC_DYN_QDMI_device_session_query_operation_property(
    MQT_SC_DYN_QDMI_Device_Session session, MQT_SC_DYN_QDMI_Operation operation, size_t num_sites,
    const MQT_SC_DYN_QDMI_Site *sites, size_t num_params, const double *params,
 ...
 *  - Create a job with @ref MQT_SC_DYN_QDMI_device_session_create_device_job.
 *  - Set parameters for the job with @ref MQT_SC_DYN_QDMI_device_job_set_parameter.
 *  - Submit the job with @ref MQT_SC_DYN_QDMI_device_job_submit.
 *  - Check the status of the job with @ref MQT_SC_DYN_QDMI_device_job_check.
 *  - Wait for the job to finish with @ref MQT_SC_DYN_QDMI_device_job_wait.
 *  - Retrieve the results of the job with @ref MQT_SC_DYN_QDMI_device_job_get_results.
 *  - Free the job with @ref MQT_SC_DYN_QDMI_device_job_free when it is no longer used.
 *
 *  @{
 */
 ...
 */
typedef struct MQT_SC_DYN_QDMI_Device_Job_impl_d *MQT_SC_DYN_QDMI_Device_Job;
 ...
 * MQT_SC_DYN_QDMI_device_job_free when it is no longer used.
 ...
 * @ref MQT_SC_DYN_QDMI_device_session_init.
 */
int MQT_SC_DYN_QDMI_device_session_create_device_job(MQT_SC_DYN_QDMI_Device_Session session,
                                          MQT_SC_DYN_QDMI_Device_Job *job);
 ...
 */
int MQT_SC_DYN_QDMI_device_job_set_parameter(MQT_SC_DYN_QDMI_Device_Job job,
 ...
 * See the @ref QDMI_device_query_device_property documentation for an example.
 */
int MQT_SC_DYN_QDMI_device_job_query_property(MQT_SC_DYN_QDMI_Device_Job job,
 ...
 * functions @ref MQT_SC_DYN_QDMI_device_job_check and @ref MQT_SC_DYN_QDMI_device_job_wait can be
 ...
 * MQT_SC_DYN_QDMI_device_job_get_results.
 ...
 */
int MQT_SC_DYN_QDMI_device_job_check(MQT_SC_DYN_QDMI_Device_Job job, QDMI_Job_Status *status);
 ...
 */
int MQT_SC_DYN_QDMI_device_job_wait(MQT_SC_DYN_QDMI_Device_Job job, size_t timeout);
 ...
 */
int MQT_SC_DYN_QDMI_device_job_get_results(MQT_SC_DYN_QDMI_Device_Job job, QDMI_Job_Result result,
