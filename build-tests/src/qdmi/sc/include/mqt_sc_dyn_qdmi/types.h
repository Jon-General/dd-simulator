 ...
 * ```
 * struct MQT_SC_DYN_QDMI_Site_impl_d {
 *   size_t id;
 * };
 * ```
 */
typedef struct MQT_SC_DYN_QDMI_Site_impl_d *MQT_SC_DYN_QDMI_Site;
 ...
 * ```
 * struct MQT_SC_DYN_QDMI_Operation_impl_d {
 *   std::string name;
 * };
 * ```
 */
typedef struct MQT_SC_DYN_QDMI_Operation_impl_d *MQT_SC_DYN_QDMI_Operation;
